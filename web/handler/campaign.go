...
func (h *campaignHandler) Create(c *gin.Context) {
	...
	var createCampaignInput campaign.CreateCampaignInput
...
func (h *campaignHandler) CreateImage(c *gin.Context) {
	...
	input.User, err = h.userService.GetUserByID(userID)
...
func (h *campaignHandler) Update(c *gin.Context) {
	...
	updateInput.User, err = h.userService.GetUserByID(userID)
	if err != nil {
		c.HTML(http.StatusOK, "campaign_edit.html", input)
		return
	}
